...
**조명 변화 등 비정형 환경에서도 견고하게 주행할 수 있도록 전처리 기반 차선 인식 개선과 상태 기반 복구 제어를 적용했으며, 미션 기반 주행 후 ArUco 마커 인식을 통해 작업 수행 시스템을 구축하였습다.**
...
* **독립 모듈을 하나의 시스템으로 통합**하는 과정을 중점으로 두었음.
* 매일 진행한 **기능 공유 및 테스트 회의**가 문제 해결 속도 향상에 큰 역할
* HSV 트랙바, 시각화 토픽, 로그 출력 등 실시간 도구가 **협업 효율을 극대화**
